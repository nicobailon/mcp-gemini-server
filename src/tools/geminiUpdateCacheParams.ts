...
const CombinedSchema = z
  .object(UpdateCacheParamsObject)
  .strict()
  .refine((data) => data.ttl !== undefined || data.displayName !== undefined, {
    message:
      "At least one of 'ttl' or 'displayName' must be provided to update the cache.",
  });
