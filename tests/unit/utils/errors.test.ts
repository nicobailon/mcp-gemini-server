...
// Add imports for environment check and error helpers
import { preCheckEnv } from '../../utils/env-check.js';
import { isMcpError } from '../../utils/error-helpers.js';
...
describe('mapToMcpError', () => {
  ...
  it('should handle errors with details', () => {
    ...
    assert.ok('details' in errorWithDetails, 'Original error should have details property');
    assert.deepStrictEqual(errorWithDetails.details, { key: 'value' }, 'Original error details should match');
